...
{
	$data = array(
		'category-video' 	=> 'Danh mục video',
		'video' 			=> 'Video',
		'video-item' 		=> 'Nội dung video',
		'video-episode' 	=> 'Video Episode',
		'category-news' 	=> 'Danh mục Tin tức - Sự kiện',
		'news' 				=> 'Tin tức - Sự kiện',
		'category-relax' 	=> 'Danh mục giải trí',
		'relax' 			=> 'Giải trí',
		'relax-item' 		=> 'Nội dung giải trí',
		'about' 			=> 'Giới thiệu',
		'notice' 			=> 'Thông báo',
		'career' 			=> 'Tuyển dụng',
		...
		'banner' 			=> 'Banner',
		'ad' 				=> 'Quảng cáo',
		'category-livetv' 	=> 'Danh mục truyền hình',
		'livetv' 			=> 'Kênh truyền hình',
		'livetv_tream' 		=> 'Stream sự kiện',
		'livetv_schedule' 	=> 'Lịch phát sóng',
		'livevideo' 		=> 'Video truyền hình',
		'category-radio' 	=> 'Danh mục phát thanh',
		'radiovideo' 		=> 'Video phát thanh',
		'radio' 			=> 'Phát thanh',
		'radio_schedule' 	=> 'Lịch phát thanh',
		'category-lessons'  => 'Category Lessons',
		'lessons'  			=> 'Lessons',
		'category-noun'  	=> 'Category Noun',
		'noun'  			=> 'Noun',
		'main-alphabet'  	=> 'Main Alphabet',
		'category-alphabet' => 'Category Alphabet',
		'alphabet'  		=> 'Alphabet',

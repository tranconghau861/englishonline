			...
			<div class="row">
				...
				<div class="col-md-4 button">
		            <a href="<?=base_url('admin/livetv/form_tream/'. $extension)?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm</a>
		            ...
		            <table class="table table-bordered">
		                ...
		                ?>
		                    <tr>
								...
								<td>
			                        <?php echo  $row->rtmphost;?>
		                        </td>
		                        
								<?php if($islang){ ?>
		                        <th class="text-center"><a href="<?=base_url('admin/livetv/language_tream/'. $extension .'/'. $row->id)?>" data-toggle="tooltip" data-placement="top" title="Làm một bản dịch sang tiếng Anh"><img src="<?=base_url('assets/admin/images/en.png')?>"></a></th>
								<?php } ?>
		                        ...
		                        <td class="text-center">
			                        <a href="<?=base_url('admin/livetv/form_tream/'. $extension .'/'. $row->id)?>" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="fa fa-pencil"></i></a> &nbsp; 
			                        <a href="<?=base_url('admin/livetv/delete/'. $extension .'/'. $row->id)?>" data-toggle="tooltip" data-placement="top" title="Xoá" class="delrow"><i class="fa fa-trash-o"></i></a> &nbsp; 

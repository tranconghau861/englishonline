			...
			<form method="post" name="adminForm" class="form-horizontal">
				...
				<?php if(in_array($extension, array('news', 'video', 'relax', 'career', 'about', 'notice'))){ ?>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<?php if(in_array($extension, array('news', 'video', 'relax'))){ ?>
							<p>
							...
							<?php if(in_array($extension, array('news', 'video'))){ ?>
							<p>
						...
						<?php } else { ?>
							...
							<?php if(in_array($extension, array('category-video', 'category-news'))){ ?>
				...
				<?php if(in_array($extension, array('category-radio', 'category-news', 'category-video', 'category-relax'))){
					$category = $this->node->parent($extension);
				?>
				<div class="form-group">
				...
				<?php if(in_array($extension, array('news', 'video', 'relax'))){
					$category = $this->node->parent('category-'. $extension);
				?>
				<div class="form-group">
				...
				<?php if(in_array($extension, array('video-item'))){
					$parent = $this->node->parents('video');
				?>
				<div class="form-group">
				...
				<?php if(in_array($extension, array('relax-item'))){
					$parent = $this->node->parents('relax');
				?>
				<div class="form-group">
				...
				<?php if(in_array($extension, array('news', 'video', 'relax', 'notice'))){ ?>
				<div class="form-group">
				...
				<?php if(in_array($extension, array('news'))){ ?>
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<?php if(@$row->fields){
								...
								foreach($fields['related'] as $key => $val){
									$node = $this->node->item($val);
								?>
							<div class="checkbox"><label><input type="checkbox" value="<?=$val?>" name="fields[related][<?=$key?>]" checked> <?=$node->title?></label></div>
						<?php }} ?>
						</div>
					</div>
				</div>
...
-->
				...
				<?php if(in_array($extension, array('news', 'career', 'video', 'relax', 'notice'))){ ?>
				<div class="form-group">
				...
				<?php if(!in_array($extension, array('news', 'career', 'video', 'relax', 'about', 'notice'))){ ?>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<a href="<?=base_url('admin/node/index/'. $extension)?>" class="btn btn-default"><i class="fa fa-eraser"></i> Huỷ</a>
					</div>
				</div>
            </form>
        </div>

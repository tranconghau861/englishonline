...
<div class="row">
    <div class="col-md-8">
        <form class="form-inline" method="get">
            ...
            <?php if (in_array($extension, array('category', 'video', 'relax', 'notice', 'career'))) { ?>
    ...
    <div class="col-md-4 button">
        <?php if (isset($admin['params'][$extension]['add'])) { ?>
            <a href="<?= base_url('admin/category/form/' . $extension) ?>" class="btn btn-success"><i
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <?php if (in_array($extension, array('category', 'category-video', 'category-relax'))) { ?>
            ...
            if ($rows) {
                $i = 1;
                foreach ($rows as $row) {
                    $parent = $this->category->item($row->parent);
                    ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            if ($parent && in_array($extension, array('category', 'category-video', 'category-relax'))) {
                        ...
                        <td class="text-center">
                            <?php
                            if (in_array($extension, array('category', 'video', 'relax', 'notice', 'career'))) {
                                if ($row->status == 1) {
                        ...
                        <td class="text-center">
                            <p>
                                <?php if (isset($admin['params'][$extension]['edit'])) { ?>
                                    <a href="<?= base_url('admin/category/form/' . $extension . '/' . $row->id) ?>"
                                       data-toggle="tooltip" data-placement="top" title="Sửa"><i
                                                class="fa fa-pencil"></i></a> &nbsp;
                                <?php } ?>

                                <?php if (isset($admin['params'][$extension]['delete'])) { ?>
                                    <a href="<?= base_url('admin/category/delete/' . $extension . '/' . $row->id) ?>"
                                ...
                                <?php if (isset($admin['params'][$extension]['add']) || isset($admin['params'][$extension]['edit'])) { ?>
                                    <a href="<?= base_url('admin/category/copy/' . $extension . '/' . $row->id) ?>"

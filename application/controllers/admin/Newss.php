...
//        }
        ...
        $view['rows'] = $this->newss->items($extension, $offset, $limit, $s, $cid /*$date_from, $date_to*/);
        $view['total'] = $total = $this->newss->total($extension, $s, $cid/*$date_from, $date_to*/);
        $view['admin'] = $admin;
        $view['extension'] = $extension;
        $view['islang'] = 1;
        $view['modlang'] = array('category-video', 'video', 'video-item', 'categorys-newss', 'newss', 'category-relax', 'relax', 'relax-item', 'about', 'career', 'notice', 'banner');
        $view['categorys'] = $this->newss->parent('categorys-' . $extension);
        $this->pagination->initialize(array(
            'base_url' => site_url('admin/newss/index/' . $extension),
            'total_rows' => $total,
            'per_page' => $limit,
        ));
        $view['pagination'] = $this->pagination->create_links();
        $this->load->view('admin/header');
        $this->load->view('admin/newss/newss_list', $view);
    }
